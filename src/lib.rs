...
pub fn main() {
    ...
    log("Nova-based VDF with MinRoot delay function");
    log("=========================================================");
    ...
    for num_iters_per_step in [1024] {
        ...
        log("Proving 1024 iterations of MinRoot per step");

        // produce public parameters
        log("Producing public parameters...");
        let pp = PublicParams::<
            E1,
            E2,
        ...
        log("Generating a RecursiveSNARK...");
        ...
        log("Verifying a RecursiveSNARK...");
        ...
        log("Generating a CompressedSNARK using Spartan with IPA-PC...");
        ...
        log("Verifying a CompressedSNARK...");
